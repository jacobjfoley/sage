...
== Usage
The wiki pages for this project on GitHub contain information about setting up and using SAGE. SAGE can be run on your own system, but you'll need an Amazon and Google Developer account in order to configure S3 thumbnail storage and Google Drive integration respectively.
