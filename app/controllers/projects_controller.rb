class ProjectsController < ApplicationController
  before_action :set_project, only: [:show, :edit, :update, :destroy, :generate_key, :reset_key, :analytics, :reset_thumbnail_bases]
  ...
  # POST /projects/1/clear_thumbnails
  ...
  private
    ...
    def check_access
      ...
      administrator_pages = ["show", "update", "edit", "destroy", "generate_key", "reset_key", "analytics", "reset_thumbnail_bases"]
